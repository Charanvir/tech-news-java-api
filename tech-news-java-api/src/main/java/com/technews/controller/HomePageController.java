...
//indicates that these controllers will control flow for the front-end user experience
@Controller
public class HomePageController {
    ...
    // will allow users to log in by calling the login.html template when the /login route is hit
    @GetMapping("/login")
    public String login(Model model, HttpServletRequest request) {
        ...
        // sends information to the Thymeleaf templates
        // will send newly created user to the template as the string user, so that it can be displayed within the string
